...
export class testVals {
    ...
    //and the high ones
    static posBVAHus = [
        ["Le' a-Marie Le' a-Marie Le' a-Marie Le' a-Marie Le",                              "B2"],
        ["O' Conn-el O' Conn-el O' Conn-el O' Conn-el O' Con",                              "B4"],
        ["12345678901234567890123456789012345678901234567890123@autest.net",                "B6"],
        ["P@ss w0rD P@ss w0rD P@ss w0rD P@ss w0rD P@ss w0rD ",                              "B8"],
        ["P@ss w0rD P@ss w0rD P@ss w0rD P@ss w0rD P@ss w0rD ",                              "V22"],
        ["Rue de l'eglise Rue de l'eglise Rue de l'eglise Rue de l'eglise ",                "B10"],
        ["Apartment 7",                                                                     "B12"],
        ["UNITED STATES",                                                                   "V29"],
        ["Llanfairpwllgwyngyllgogerychwndrobwllllantysiliogo",                              "B14"],
        ["CA",                                                                              "V36"],
        ["99999",                                                                           "B16"],
        ["999-999-9999",                                                                    "B22"]
    ]
    ...
    static posBVAHca = [
        ...
        ["Apartment 7",                                                                              "B12"],
        ["CANADA",                                                                                   "V31"],
        ["Taumatawhakatangihangakoauauotamateaturipukakapiki",                                       "B14"],
        ["BC",                                                                                       "V37"],
        ["1234567890",                                                                               "B20"],
        ["999-999-9999",                                                                             "B22"]
    ]
